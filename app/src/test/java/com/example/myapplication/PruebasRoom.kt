...
import com.example.myapplication.Interfaces.DAOUsuarios
    ...
    * */
    test("insertarUsuario debe llamar al DAO") {
        runTest(testDispatcher) {
            ...
            // When
            val usuario = Usuario("Carlos", "carlos@test.com", "pass")
            mockDao.insert(usuario)

            // Then
            //Verifica que la funcion haya sido llamada
            coVerify { mockDao.insert(any()) }
            usuarioCapturado.captured.username shouldBe "Carlos"
